...
/**
 * Author: shaoqw
 * Date: 2020/12/28 19:50
 * Description: 进程相关工具类
 */
public class YxpProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) YxpUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(YxpUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) YxpUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) YxpUtils.getApp()
    ...
    public static boolean isMainProcess() {
        return YxpUtils.getApp().getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Application app = YxpUtils.getApp();
