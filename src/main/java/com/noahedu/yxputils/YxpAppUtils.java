...
public class YxpAppUtils {
    ...
    public static void installApp(final String filePath) {
        installApp(YxpUtilsBridge.getFileByPath(filePath));
    }
    ...
    public static void installApp(final File file) {
        Intent installAppIntent = YxpUtilsBridge.getInstallAppIntent(file);
        if (installAppIntent == null) return;
        YxpUtils.getApp().startActivity(installAppIntent);
    }
    ...
    public static void installApp(final Uri uri) {
        Intent installAppIntent = YxpUtilsBridge.getInstallAppIntent(uri);
        if (installAppIntent == null) return;
        YxpUtils.getApp().startActivity(installAppIntent);
    }
    ...
    public static void uninstallApp(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return;
        YxpUtils.getApp().startActivity(YxpUtilsBridge.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppInstalled(final String pkgName) {
        if (YxpUtilsBridge.isSpace(pkgName)) return false;
    ...
    public static boolean isAppRoot() {
        YxpShellUtils.CommandResult result = YxpUtilsBridge.execCmd("echo root", true);
    ...
    public static boolean isAppDebug() {
        return isAppDebug(YxpUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return false;
        ApplicationInfo ai = YxpUtils.getApp().getApplicationInfo();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(YxpUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) YxpUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) return false;
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                if (aInfo.processName.equals(YxpUtils.getApp().getPackageName())) {
                    return true;
                }
            }
        }
    ...
    public static boolean isAppForeground(@NonNull final String pkgName) {
        return !YxpUtilsBridge.isSpace(pkgName) && pkgName.equals(YxpUtilsBridge.getForegroundProcessName());
    }
    ...
    public static void launchApp(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return;
        Intent launchAppIntent = YxpUtilsBridge.getLaunchAppIntent(packageName);
        if (launchAppIntent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        YxpUtils.getApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = YxpUtilsBridge.getLaunchAppIntent(YxpUtils.getApp().getPackageName());
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        ...
        YxpUtils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(YxpUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String pkgName) {
        if (YxpUtilsBridge.isSpace(pkgName)) return;
        Intent intent = YxpUtilsBridge.getLaunchAppDetailsSettingsIntent(pkgName, true);
        if (!YxpUtilsBridge.isIntentAvailable(intent)) return;
        YxpUtils.getApp().startActivity(intent);
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode) {
        launchAppDetailsSettings(activity, requestCode, YxpUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode, final String pkgName) {
        if (activity == null || YxpUtilsBridge.isSpace(pkgName)) return;
        Intent intent = YxpUtilsBridge.getLaunchAppDetailsSettingsIntent(pkgName, false);
        if (!YxpUtilsBridge.isIntentAvailable(intent)) return;
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(YxpUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return null;
        try {
            PackageManager pm = YxpUtils.getApp().getPackageManager();
    ...
    public static int getAppIconId() {
        return getAppIconId(YxpUtils.getApp().getPackageName());
    }
    ...
    public static int getAppIconId(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return 0;
        try {
            PackageManager pm = YxpUtils.getApp().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppPackageName() {
        return YxpUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(YxpUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(YxpUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(YxpUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(YxpUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode(final String packageName) {
        if (YxpUtilsBridge.isSpace(packageName)) return -1;
        try {
            PackageManager pm = YxpUtils.getApp().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(YxpUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(YxpUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(YxpUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(YxpUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(YxpUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            return YxpUtils.getApp().getPackageManager().getApplicationInfo(pkgName, 0).uid;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    private static String getAppSignatureHash(final String packageName, final String algorithm) {
        ...
        return YxpUtilsBridge.bytes2HexString(YxpUtilsBridge.hashTemplate(signature[0].toByteArray(), algorithm))
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(YxpUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getApkInfo(final String apkFilePath) {
        if (YxpUtilsBridge.isSpace(apkFilePath)) return null;
        PackageManager pm = YxpUtils.getApp().getPackageManager();
        if (pm == null) return null;
