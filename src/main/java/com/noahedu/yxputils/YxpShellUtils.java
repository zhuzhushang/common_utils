...
public class YxpShellUtils {
     ...
     * @return the task
     */
    public static YxpUtils.Task<CommandResult> execCmdAsync(final String command,
                                                                  final boolean isRooted,
                                                                  final YxpUtils.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static YxpUtils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                         final boolean isRooted,
                                                         final YxpUtils.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static YxpUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final YxpUtils.Consumer<CommandResult> consumer) {
    ...
    public static YxpUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final boolean isNeedResultMsg,
                                                         @NonNull final YxpUtils.Consumer<CommandResult> consumer) {
        return YxpUtilsBridge.doAsync(new YxpUtils.Task<CommandResult>(consumer) {
            @Override
